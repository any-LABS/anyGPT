...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('-n', '--name', dest='name', default='princess_of_mars', help="The name of the dataset")
    parser.add_argument('-u', '--url', dest='url', default='https://www.gutenberg.org/cache/epub/62/pg62.txt',
...
def _save_to_bin(name, train_ids, val_ids):
...
def _tokenize_data(name, bpe):
    ...
    _save_to_bin(name, train_ids, val_ids)
